...
function SignUpForm() {
  ...
  return (
    <form className="w-115 flex items-end relative justify-start flex-col rounded-xl p-12.5 bg-[#FFFFFF] gap-3">
      <button onClick={closeModal} className="cursor-pointer absolute flex top-0 right-0">
        <CloseIcon />
      </button>
        ...
        <div className=" flex flex-col w-full gap-4">
          <div className=" flex flex-col w-full gap-4">
            <div className=" flex flex-col gap-6">
              ...
              <Input value="1" onChange={() =>{}} name="email" id="email" type="email" label="Email*" placeholder="you@example.com" />
            </div>
            <CTA_Button
          ...
          <div className="flex flex-col items-center w-full justify-center gap-2">
            ...
            <div className="px-[60px] flex items-center justify-center gap-2">
              <p className="w-[147px] h-[15px] justify-center items-center flex text-grayscale-500 text-helper-s-regular">
                Already have an account?{" "}
              </p>
              <p className="w-[41px] h-[17px] justify-center items-center text-underlined-sm  text-grayscale-900 text-body-xs">
                Log In{" "}
              </p>
            </div>
          </div>
