...
function WeeklyScheduleComp({ disabled, slot, updateFlow, flowId }: Props) {
  ...
  return (
    <button
      ...
      className={`flex ${disabled ? "cursor-default border-grayscale-200 bg-gray-100 text-grayscale-200" : flowId === slot.id ? "border-[#958FEF] bg-[#DDDBFA] text-[#4F46E5]" : "bg-grayscale-50 border-grayscale-200  cursor-pointer text-grayscale-800 hover:border-[#958FEF] hover:bg-[#DDDBFA] hover:text-[#4F46E5]"} items-center justify-center w-73.75 h-22.75 rounded-xl border p-2.5 gap-2.5 transition-all duration-500 ease-out `}
    >
