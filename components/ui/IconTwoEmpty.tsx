...
function IconTwoEmpty() {
  return (
    ...
    >
      ...
      />
      <path
        d="M10.5236 12.0179C10.5236 8.30393 16.941 8.30393 16.941 12.0179C16.941 14.8213 12.7485 17.2385 10.5236 18.7677C10.5236 18.7677 14.6953 18.1717 17.4764 18.7677"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
