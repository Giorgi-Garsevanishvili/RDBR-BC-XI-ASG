...
function IconOneEmpty() {
  return (
    ...
    >
      ...
      />
      <path
        d="M14.8788 18.6866V9.3125L11.6565 11.656"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
